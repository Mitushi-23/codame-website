  ...
  return (
    <div className="home_page">
      ...
      <div class="sec-1 p-5 bg-white m-20 rounded-2xl">
        ...
        <div className="what-do-we-do z-10">
        {/* <Circle
          color="#3DD5A273"
          size={["150px", "150px", "180px", "180px"]}
          zIndex={1}
        /> */}
          <h1 className="text-center font-bold text-6xl m-5 font-encodeSans">
            What Do We Do?
          </h1>
          <div className="box-1 flex flex-row m-5">
            <div className="text">
              <h2 className="font-semibold p-3 m-3 text-[2rem] font-belleza">
                {" "}
                Encouraging the students to code
              </h2>
              <p className="font-medium p-3 m-3 text-xl font-poppins">
                Lorem ex aliquip reprehenderit velit velit. Quis voluptate
                officia irure adipisicing dolore dolore Lorem ex labore tempor
                nostrud mollit. Tempor ad mollit labore cillum ullamco deserunt.
                Deserunt consectetur ullamco fugiat consequat.
              </p>
            </div>
